...
<p align="center">
  ...
  <a href="#分类"><img src="https://img.shields.io/badge/Curated%20Projects-336%2B-2563eb?style=flat-square" alt="Projects Count" /></a>
...
- 🛡️ **严格拒绝概念炒作**：全网严选 **336+** 个绑定真实公开开源源码版本的落地项目，覆盖 17 大核心工程赛道。
...
> **[搜索与筛选 ↗](https://logicrw.github.io/awesome-jev-projects/)** · **336 个精选项目**
...
- [命令行与流水线 (19)](https://logicrw.github.io/awesome-jev-projects/categories/cli-pipelines/)
...
- [数据与搜索 (18)](https://logicrw.github.io/awesome-jev-projects/categories/data-search/)
...
- [**slop-grader**](https://github.com/lukstei/slop-grader) — 这是一个基于规则的 CLI 工具，用 Jev 的 Score 做文档级打分、用 Choice 和 Noul 做逐行违规标记，并把结果交给 Agent 去修复文本和 Markdown 文件。
  ...
  - [项目详情与固定源码](https://logicrw.github.io/awesome-jev-projects/projects/lukstei/slop-grader/) · 许可证: 未声明
