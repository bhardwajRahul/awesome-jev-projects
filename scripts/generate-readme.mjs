...
for (const locale of LOCALES) {
  ...
  const subtitle=locale==='zh'?'Jev 开源与公开源码项目目录':locale==='ja'?'Jev のオープンソース・公開コードを用途で探す':locale==='ko'?'Jev 오픈소스와 공개 코드를 용도별로 탐색':'Jev open-source and public code, organized by use case';
  const svg=`<svg xmlns="http://www.w3.org/2000/svg" width="1100" height="240" viewBox="0 0 1100 240" role="img" aria-label="Awesome Jev"><rect width="1100" height="240" rx="16" fill="#fafafa"/><rect x="1" y="1" width="1098" height="238" rx="15" fill="none" stroke="#dfe5d8"/><rect x="46" y="69" width="60" height="60" rx="14" fill="#263620"/><path d="M80 80 62 102h15l-6 19 21-27H78l7-14" fill="#d7fa91"/><text x="128" y="116" font-family="Inter,Arial,sans-serif" font-size="48" font-weight="700" letter-spacing="-1.4" fill="#202820">Awesome Jev</text><text x="48" y="177" font-family="Inter,Arial,'PingFang SC','Yu Gothic','Malgun Gothic',sans-serif" font-size="22" fill="#4c5e42">${escapeHTML(subtitle)}</text><path d="M891 82h102m-24-18 24 18-24 18" fill="none" stroke="#658947" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>\n`;
