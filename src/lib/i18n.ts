...
export const english: Record<string, string> = {
  ...
  "全部": "All",
  "1k+ 顶流": "1k+ Stars",
  "GitHub Stars 达到 1,000 的热门项目。": "Projects with at least 1,000 GitHub stars.",
  ...
  "采用 MIT、Apache、BSD 等宽松开源许可。": "Permissive open-source licenses including MIT, Apache, and BSD.",
  ...
  "目录已更新 (新增 N 个项目)，已自动同步": "Catalog updated (N new projects), synced automatically",
  重试: "Try again",
  ...
  "抽张灵感": "Draw card",
  "复制 Markdown 引用": "Copy Markdown link",
  "Markdown 引用已复制": "Markdown link copied",
  "复制 README 徽章": "Copy README badge",
  "README 徽章已复制": "README badge copied",
  "项目分享文案已复制": "Project share text copied",
  "无法自动复制，请使用详情中的项目链接。":
...
export const japanese: Record<string, string> = {
  ...
  "全部": "すべて",
  "1k+ 顶流": "1k+ Stars",
  "GitHub Stars 达到 1,000 的热门项目。": "GitHub Stars が 1,000 以上の注目プロジェクト。",
  "潜力新秀": "新着の注目株",
  "近 90 天创建、当前有 10–999 Stars 的项目，按快照筛选。": "過去 90 日間に作成され、現在のスナップショットで Stars が 10〜999 のプロジェクト。",
  "商业友好": "商用向け",
  "采用 MIT、Apache、BSD 等宽松开源许可。": "MIT、Apache、BSD などの寛容なオープンソースライセンスを採用。",
  "按匹配度排序": "関連度順",
  ...
  "目录已更新 (新增 N 个项目)，已自动同步": "カタログを更新しました（新規 N 件）、自動同期済み",
  "重试": "再試行",
  ...
  "项目链接已复制": "リンクをコピーしました",
  "抽张灵感": "ひらめきカード",
  "复制 Markdown 引用": "Markdown リンクをコピー",
  "Markdown 引用已复制": "Markdown リンクをコピーしました",
  "复制 README 徽章": "README バッジをコピー",
  "README 徽章已复制": "README バッジをコピーしました",
  "项目分享文案已复制": "共有テキストをコピーしました",
...
export const korean: Record<string, string> = {
  ...
  "全部": "전체",
  "1k+ 顶流": "1k+ Stars",
  "GitHub Stars 达到 1,000 的热门项目。": "GitHub Stars가 1,000 이상인 인기 프로젝트입니다.",
  "潜力新秀": "신흥 프로젝트",
  "近 90 天创建、当前有 10–999 Stars 的项目，按快照筛选。": "최근 90일 내 생성되었으며 현재 스냅샷에서 Stars가 10–999인 프로젝트입니다.",
  "商业友好": "상용 친화적",
  "采用 MIT、Apache、BSD 等宽松开源许可。": "MIT, Apache, BSD 등 허용적 오픈소스 라이선스를 채택한 프로젝트입니다.",
  "按匹配度排序": "관련도순",
  ...
  "目录已更新 (新增 N 个项目)，已自动同步": "목록이 업데이트되었습니다(신규 N개 프로젝트), 자동 동기화됨",
  "重试": "다시 시도",
  ...
  "抽张灵感": "영감 뽑기",
  "复制 Markdown 引用": "마크다운 링크 복사",
  "Markdown 引用已复制": "마크다운 링크를 복사했습니다",
  "复制 README 徽章": "README 배지 복사",
  "README 徽章已复制": "README 배지를 복사했습니다",
  "项目分享文案已复制": "공유 텍스트를 복사했습니다",
