...
const copy = {
  zh: { title: '抽张灵感卡', intro: '把熟悉的排序放一边，遇见一个没看过的项目。', close: '关闭抽卡机', rising: '潜力新星', decision: 'Jev 决策点', github: '前往 GitHub', again: '再抽一张', summary: '复制摘要', link: '复制链接', share: '分享卡片', copied: '已复制', shared: '已打开分享', failed: '无法自动复制，请选择下方内容手动复制。', manual: '手动复制内容', empty: '暂时没有可抽取的已审校项目。', note: '随机发现 · 星级只表示 GitHub 关注度', drawn: '本次抽中', drawBadge: '第 {n} 抽', streak: '已连续探索 {n} 个项目' },
  en: { title: 'Draw an inspiration card', intro: 'Step outside the usual ranking. Find a project you have not tried.', close: 'Close card draw', rising: 'Rising project', decision: 'Jev decision point', github: 'Open GitHub', again: 'Draw again', summary: 'Copy summary', link: 'Copy link', share: 'Share card', copied: 'Copied', shared: 'Share opened', failed: 'Automatic copy is unavailable. Select the text below to copy it.', manual: 'Text to copy manually', empty: 'No reviewed projects are available to draw yet.', note: 'Random discovery · Tiers reflect GitHub stars only', drawn: 'You drew', drawBadge: 'Draw #{n}', streak: '{n} projects explored in a row' },
  ja: { title: 'ひらめきのカードを引く', intro: 'いつもの順位から離れて、まだ知らないプロジェクトに出会おう。', close: 'カードを閉じる', rising: '期待の新星', decision: 'Jev の判断ポイント', github: 'GitHub を開く', again: 'もう一枚引く', summary: '概要をコピー', link: 'リンクをコピー', share: 'カードを共有', copied: 'コピーしました', shared: '共有を開きました', failed: '自動コピーできません。下のテキストを選択してコピーしてください。', manual: '手動コピー用テキスト', empty: '抽選できる確認済みプロジェクトはまだありません。', note: 'ランダムな発見 · ランクは GitHub の Star 数のみ', drawn: '今回のカード', drawBadge: '{n}回目', streak: '連続 {n} プロジェクト探索中' },
  ko: { title: '영감 카드 뽑기', intro: '익숙한 순위에서 벗어나 새로운 프로젝트를 만나 보세요.', close: '카드 닫기', rising: '떠오르는 프로젝트', decision: 'Jev의 판단 지점', github: 'GitHub 열기', again: '다시 뽑기', summary: '요약 복사', link: '링크 복사', share: '카드 공유', copied: '복사됨', shared: '공유 창 열림', failed: '자동 복사가 불가능합니다. 아래 텍스트를 선택해서 복사하세요.', manual: '직접 복사할 텍스트', empty: '아직 뽑을 수 있는 검토 완료 프로젝트가 없습니다.', note: '무작위 발견 · 등급은 GitHub Star 수만 나타냅니다', drawn: '이번 카드', drawBadge: '{n}회차', streak: '연속 {n}개 프로젝트 탐색 중' },
          ...
          <article ref={card} key={draw.turn} className="gacha-card" data-rarity={rarity(p)} onPointerMove={tilt} onPointerLeave={resetTilt} onPointerCancel={resetTilt}>
            <div className="gacha-card-top">
              <div className="gacha-card-badges">
                <span className="gacha-counter-badge" title={formatStreak(t.streak, draw.turn + 1, locale)}>
                  <Sparkles size={11} aria-hidden="true" />
                  {t.drawBadge.replace('{n}', String(draw.turn + 1))}
                </span>
